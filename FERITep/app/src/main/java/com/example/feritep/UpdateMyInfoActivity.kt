...
class UpdateMyInfoActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        supportActionBar!!.title = "Promijeni informacije"
        ...
        btUploadProfilePic.setOnClickListener {
            ...
            if (filePath != "") {
                ...
                AlertDialog.Builder(this)
                    .setTitle("Greška")
                    .setMessage("Slika nije odabrana!")
            ...
            if (resultCode == Activity.RESULT_OK) {
                ...
                try {
                    if (fileExtension.equals("img") || fileExtension.equals("jpg") || fileExtension.equals("jpeg") || fileExtension.equals(
                        ...
                        AlertDialog.Builder(this)
                            .setTitle("Greška")
                            .setMessage("Tip podatka nije podržan!")
                            .show()
                    }
                } catch (ex: Exception) {
    ...
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        when (item.itemId) {
            R.id.action_update_done -> {
                //Snackbar.make(findViewById(R.id.update_info_activity_root_view),"Nešto", Snackbar.LENGTH_LONG).show()
                ...
                Toast.makeText(this, "Informacije promijenjene", Toast.LENGTH_LONG).show()
    ...
    private fun uploadImageToFirebaseStorage(url: String?) {
        ...
        val urlTask = uploadTask?.continueWithTask(Continuation<UploadTask.TaskSnapshot, Task<Uri>> { task ->
            ...
            if (task.isSuccessful) {
                ...
                Log.d("Petar", "URL za profil je: ${sharedPreference.getString("profileurl", null)}")
                ...
                dialog.dismiss()
                Toast.makeText(this, "Postavljanje nove profilne slike završeno.", Toast.LENGTH_LONG).show()
            } else {
                // Handle failures
                // ...
            }
            ...
            dialog.dismiss()
            Toast.makeText(this, "Postavljanje neuspješno!", Toast.LENGTH_LONG).show()
        }
