...
import com.example.feritep.models.Notifications
...
class MainActivity : AppCompatActivity(), NavigationView.OnNavigationItemSelectedListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        notiTable.orderByChild("targetUser").equalTo(mkptFromPref).addValueEventListener(object :
            ValueEventListener {
    ...
    private fun fatchLastLocation() {
        ...
        task.addOnSuccessListener {
            if (it != null) {
                ...
                Log.d("Petar", "current location is : ${it.longitude} ${it.latitude}")
            }//end of if
        }
    }
    ...
    override fun onNavigationItemSelected(item: MenuItem): Boolean {
        ...
        when (item.itemId) {
            R.id.nav_dashboard -> {
                ...
                //Log.d("Petar","Working before fragment creating")
                val fragment = DashboardFragment()
                //Log.d("Petar","Working after fragment creating")
           ...
           /* R.id.nav_medical_leave -> {
            ...
            R.id.nav_logout -> {
                ...
                AlertDialog.Builder(this)
                    ...
                    .setPositiveButton("Odjavite se", DialogInterface.OnClickListener { dialogInterface, i ->
