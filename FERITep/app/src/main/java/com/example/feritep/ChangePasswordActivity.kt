...
class ChangePasswordActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        supportActionBar!!.title = "Promijenite lozinku"
        ...
        btReset.setOnClickListener {
            ...
            if (password.isEmpty() || confirmPassword.isEmpty()) {
                AlertDialog.Builder(this)
                    .setTitle("Greška")
                    .setMessage("Polje za unos lozinke nije ispunjeno!")
                    .setPositiveButton(
                        "U redu",
                ...
                if (password != confirmPassword) {
                    AlertDialog.Builder(this)
                        .setTitle("Pogreška")
                        .setMessage("Lozinka nije ispravna!")
                        .setPositiveButton(
                            "U redu",
                            DialogInterface.OnClickListener { dialogInterface, i -> dialogInterface.dismiss() })
                        .show()
                    ...
                    AlertDialog.Builder(this)
                        .setTitle("Potvrdite")
                        .setMessage("Jeste li sigurni da želite promijeniti vašu lozinku?")
                        .setNegativeButton("Prekid", DialogInterface.OnClickListener { dialogInterface, i ->
                            dialogInterface.dismiss()
                        })
                        .setPositiveButton("Promijeni", DialogInterface.OnClickListener { dialogInterface, i ->
                            ...
                            Toast.makeText(this, "Lozinka uspješno promijenjena", Toast.LENGTH_LONG).show()
                        }).show()
                }
            }
