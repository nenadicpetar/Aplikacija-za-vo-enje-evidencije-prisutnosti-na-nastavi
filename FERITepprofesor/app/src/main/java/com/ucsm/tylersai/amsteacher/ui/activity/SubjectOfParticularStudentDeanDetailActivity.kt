...
class SubjectOfParticularStudentDeanDetailActivity : AppCompatActivity() {
    ...
    private val SEMESTERMONTH = "09,10,11,12"
    private val DATEFORMATT = "dd-MM-yyyy"
    private val HOLIDAYS: String = "16-07-2019,19-07-2019"
    private var mkpt = ""

    private var attendancePercentage = 0.00

    private var september = "0"
    private var october = "0"
    private var november = "0"
    private var december = "0"
                ...
                override fun onDataChange(dataSnapshot: DataSnapshot) {
                    ...
                    dataSnapshot.children.forEach {
                        ...
                        it.children.forEach {
                            ...
                            // Log.d("Petar", "detail subject: dailydate is $dailyDate subject code is $subjectCodefromDB")
...
//---------------------------------------------------------------------------------------------------------second
        ...
        for (element in semMonthAry) {//whole month loop
            ...
            // Log.d("Petar", "Sem ary:: ${semMonthAry[b]}, number of days in month ${numDaysInMonth}, start date is : $startDateI")
            ...
            for (i in startDateI until numDaysInMonth + 1) {//loop the whole month
                ...
                if (eligible) {
                    ...
                    Log.d("Petar", "Detail Non eligible date is : $dateToCheck")
                }
            }//end of for
                    ...
                    .addValueEventListener(object : ValueEventListener {
                        ...
                        override fun onDataChange(dataSnapshot: DataSnapshot) {
                            ...
                            if (dataSnapshot.exists()) {
                                ...
                                Log.d("Petar", "No attendance for date $dateCheckAttendannce with subject code ${code}")
                            }
