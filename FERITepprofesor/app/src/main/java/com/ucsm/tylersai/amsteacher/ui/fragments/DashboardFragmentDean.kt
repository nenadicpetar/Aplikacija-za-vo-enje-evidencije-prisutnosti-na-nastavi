...
class DashboardFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        activity.supportActionBar!!.title = "Profesor"
        ...
        dataset.clear()
        dataset.add(ClassAttendanceProgress("Programsko inženjerstvo", "80"))
        dataset.add(ClassAttendanceProgress("Informacijske i podatkovne znanosti", "70"))
