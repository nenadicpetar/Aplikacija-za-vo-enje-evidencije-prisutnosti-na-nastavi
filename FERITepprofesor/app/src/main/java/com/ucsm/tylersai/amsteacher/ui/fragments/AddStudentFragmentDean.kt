...
class AddStudentFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        activity.supportActionBar!!.title = "Dodavanje studenata"
        ...
        sectionMajorClassTable.addValueEventListener(object : ValueEventListener {
            override fun onCancelled(p0: DatabaseError) {
                Toast.makeText(
                    context,
                    "Dogodila se greška ${p0.toException().message}",
                    Toast.LENGTH_LONG
                ).show()
            }
            ...
            override fun onDataChange(dataSnapshot: DataSnapshot) {
                ...
                dataSnapshot.children.forEach {
                    ...
                    // Log.d("Petar","sectionMajorClassAry ${it.key}")
                        ...
                        .addValueEventListener(object : ValueEventListener {
                            ...
                            override fun onDataChange(dataSnapshot: DataSnapshot) {
                                ...
                                dataSnapshot.children.forEach { it ->
                                    ...
                                    //Log.d("Petar", "prestudent is :::: ${prestudent!!.name}, key:: ${it.key}")
