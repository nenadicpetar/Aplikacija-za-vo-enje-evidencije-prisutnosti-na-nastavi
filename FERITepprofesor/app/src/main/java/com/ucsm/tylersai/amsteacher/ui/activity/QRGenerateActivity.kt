...
class QRGenerateActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        supportActionBar!!.title = "Pokupi prisutnost"
        ...
        Log.d("Petar", "substring of month is: $monthFromQR original is $todayDateFromQR")
        ...
        try {
            ...
            Log.d("Petar", "today encrypted text is: $encrypted")
            Log.d("Petar", "today decrypted text is: ${encrypted.decrypt("amsucsmapp123456")}")
        ...
        Toast.makeText(this, "QR kod generiran", Toast.LENGTH_SHORT).show()
        ...
        when (item!!.itemId) {
            android.R.id.home -> {
                AlertDialog.Builder(this@QRGenerateActivity)
                    .setTitle("Potvrda")
                    .setMessage("Jeste li sigurni da želite napustiti ovu aktivnost")
                    .setPositiveButton(
                        "Da",
                    ...
                    override fun onDataChange(dataSnapshot: DataSnapshot) {
                        ...
                        dataSnapshot.children.forEach {
                            ...
                            if (result!!.subject.contains("$todaySubCodeFromQR: $todaySubNameFromQR")) {
                                studAry.add(result!!)
                                Log.d("Petar", "Student who take this course ${tvSubName.text} is:  ${result!!.name}")
                            } else {
                                Log.d("Petar", "Student : not contain programming language")
                            }
                        }//end of for each
                        ...
                        attendanceTable.child(monthFromQR).child(todayDateFromQR).child(todaySubCodeFromQR)
                            .addListenerForSingleValueEvent(object : ValueEventListener {
                                ...
                                override fun onDataChange(dataSnapshot: DataSnapshot) {
                                    ...
                                    //Log.d("Petar","keyyyyyyyyy ${dataSnapshot.key }")
                                    ...
                                    dataSnapshot.children.forEach {
                                        ...
                                        Log.d("Petar", "Subject code from pending table: ${attendance.subjectcode}")
                                    }//end of datasnapshot
                                    ...
                                    for (i in 0 until studAry.size) {
                                        ...
                                        for (a in 0 until attendAry.size) {
                                            ...
                                            if (studForCheck.mkpt == attendAry[a].mkpt) {
                                                Log.d("Petar", "student ${studForCheck.name}is coming to school")
                                                isAbsent = false
                                                break
                                        ...
                                        if (isAbsent) {
                                            ...
                                            Log.d("Petar", "student ${studForCheck.name} isn't absent ")
                                        }
                                    }//end of outer for
                                   ...
                                   /* if (absentStudents.equals("")) {
                                        absentStudents = "Nema prisutnosti!"
                                    } */

                                    Log.d("Petar", "student total array size is ${studAry.size}")
                                    //absentStudents += "\nTotal student: ${studAry.size}\nAbsent student: ${absentCount}\nPresent Student: ${(studAry.size) - absentCount}\n"

                                    AlertDialog.Builder(this@QRGenerateActivity)
                                        .setTitle("Informacija")
                                        .setMessage("Prisutnost zabilježena")
                                        .setPositiveButton(
                                            "Potvrdi",
                                            DialogInterface.OnClickListener { dialogInterface, i ->
                                                dialogInterface.dismiss()
                                                ...
                                                Toast.makeText(
                                                    this@QRGenerateActivity,
                                                    "Podaci o prisutnosti zabilježeni.",
                                                    Toast.LENGTH_LONG
                                                ).show()
                                                finish()
                                            })
