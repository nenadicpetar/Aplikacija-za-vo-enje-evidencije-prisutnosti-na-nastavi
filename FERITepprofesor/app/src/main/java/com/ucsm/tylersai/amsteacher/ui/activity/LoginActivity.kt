    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btLogin.setOnClickListener {
            ...
            if (edtMkpt.text.toString() == "" || edtPw.text.toString() == "") {
                Toast.makeText(applicationContext, "Unesite korisnički ID i lozinku", Toast.LENGTH_LONG)
                    .show()
            } else if (edtMkpt.text.length < 4) {
                Toast.makeText(applicationContext, "Unesite ispravan ID", Toast.LENGTH_LONG)
                    .show()
            } else {

                val userid = edtMkpt.text.toString()

                Log.d("Petar", "child................${userid}")
                    ...
                    .addListenerForSingleValueEvent(object : ValueEventListener {
                        ...
                        override fun onDataChange(dataSnapshot: DataSnapshot) {
                            ...
                            if (dataSnapshot.exists()) {
                                ...
                                Log.d("Petar", "name is: ${teacher!!.name} and password is: $decryptedPassword")
