...
class UpdateMyInfoActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        supportActionBar!!.title = "Promijeni podatke"
        ...
        btUploadProfilePic.setOnClickListener {
            ...
            if (filePath != "") {
                ...
                AlertDialog.Builder(this)
                    .setTitle("Greška")
                    .setMessage("Fotografija nije odabrana!")
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        if (requestCode == 1) {
            if (resultCode == Activity.RESULT_OK) {
                ...
                Log.d("Petar", "Filepath is $filePath")
                val fileExtension = filePath.substring(filePath.lastIndexOf(".") + 1)


                Log.d("Petar", "Filepath extension: $fileExtension")
                ...
                try {
                    if (fileExtension.equals("img") || fileExtension.equals("jpg") || fileExtension.equals("jpeg") || fileExtension.equals(
                        ...
                        AlertDialog.Builder(this)
                            .setTitle("Greška")
                            .setMessage("Format nije podržan!")
                            .show()
                    }
                } catch (ex: Exception) {
                    Log.d("Petar", "Exception: ${ex.message.toString()}")
                }
            }
        }
    }
    ...
    private fun uploadImageToFirebaseStorage(url: String?) {
        ...
        val urlTask = uploadTask?.continueWithTask(Continuation<UploadTask.TaskSnapshot, Task<Uri>> { task ->
            ...
            if (task.isSuccessful) {
                ...
                // Log.d("Petar", "download link is:::: $downloadUri")
                ...
                dialog.dismiss()
                Toast.makeText(this, "Postavljanje profilne fotografije dovršeno", Toast.LENGTH_LONG)
                    .show()
            } else {
                // Handle failures
                // ...
            ...
            dialog.dismiss()
            Toast.makeText(this, "Greška postavljanja!", Toast.LENGTH_LONG).show()
        }
