...
class ChangePasswordActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        supportActionBar!!.title = "Promijeni lozinku"
        ...
        btReset.setOnClickListener {
            ...
            if (password.isEmpty() || confirmPassword.isEmpty()) {
                AlertDialog.Builder(this)
                    .setTitle("Greška")
                    .setMessage("Polje za lozinku je prazno.")
                    .setPositiveButton(
                        "U redu"
                ...
                if (password != confirmPassword) {
                    ...
                    AlertDialog.Builder(this)
                        .setTitle("Potvrditi")
                        .setMessage("Jeste li sigurni da želite promijeniti lozinku?")
                        .setNegativeButton("Prekid") { dialogInterface, i ->
                            dialogInterface.dismiss()
                        }
                        .setPositiveButton("Promijeni") { dialogInterface, i ->
                            ...
                            Toast.makeText(this, "Lozinka uspješno promijenjena", Toast.LENGTH_LONG)
                                .show()
